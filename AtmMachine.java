...
class Atm {
    ...
    private int PIN;
    private float Account_Balance = 1000.0f; // Initial Balance is Set to 1000 INR.
    private static final HashMap<String, Integer> Users = new HashMap<>(); // Valid Users of ATM.
    private boolean isValid = false;
    private HashMap<Date, String> transactions_History = new HashMap<>(); // Stores the Transaction History of Each
                                                                          // User's Operation.
    ...
    protected final static void startMachine() {
        ...
        Users.put("A86581742011", 2002);
        Users.put("A86581742012", 2003);
        Users.put("A86581742013", 2000);
        Users.put("A86581742014", 2001);
        Users.put("A86581742015", 2004);
        Users.put("A86581742016", 2006);
        Users.put("A86581742017", 2007);
    }
    ...
    // Grants access to Machine only if the Credentials are already present in
    // Users.
